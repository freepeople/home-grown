...
// but convert to vanilla js
// and built on top with browserfy help :)
'use strict';
...
SliderProto.init = function() {
    ...
    if ($directionNav) {
        prevNav = '<a href="#" class="lean-slider-prev">' + this.options.prevText + '</a>';
        nextNav = '<a href="#" class="lean-slider-next">' + this.options.nextText + '</a>';
        $directionNav.innerHTML = prevNav + nextNav;
...
},{"./utils/addClass":2,"./utils/addListener":3,"./utils/extend":4,"./utils/removeClass":5}],2:[function(require,module,exports){
'use strict';
